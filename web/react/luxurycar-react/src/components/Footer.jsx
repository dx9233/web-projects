    ...
    <footer className="footer">
      <div className="footer-top">
        <div className="footer-brand">
          <h3>LuxureDetails</h3>
          <p>
            Experience the prestige of a professionally
            <br />
            detailed car, radiating elegance and refinement
            <br />
            at every turn.
          </p>
        </div>
        <div className="footer-columns">
          ...
          <div>
            ...
            <ul>
              <li>
                <a href="https://example.com/">Get a quote</a>
              </li>
              <li>
                <a href="https://example.com/">Contact form</a>
              </li>
              <li>
                <a href="https://example.com/">Email us</a>
              </li>
            </ul>
          </div>
          <div>
      ...
      <div className="footer-bottom">
        ...
        <div className="footer-links">
          ...
          <a href="https://www.figma.com/design/YEuQIpkKqpy4m3olwAtd3v/Luxury-Car-Detailing-Landing-Page--Community-?node-id=2-139&t=D54cmUptUO6p3HvG-1">
            Design
          </a>
        </div>
      </div>
